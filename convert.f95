...
!   Test for non-executable statement keyword
   99 IF (ASSIGN) GO TO 98
      ...
      SKIP=SKIP.or.L3==31 !IHH Output parameter statements
      SKIP = .NOT.SKIP
      write(*,*)'Preskipped stamnt ',stamnt(:LENST),SKIP
      IF (SKIP) GO TO 98
!
...
!   name
      ...
      if(L3==31 .and. index(stamnt,'''')==0)goto 97  ! IHH Keep all parameter statements
...
!         write(*,*)'Special stamnt=',stamnt(:50)
!
